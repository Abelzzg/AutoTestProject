...
public class NewSolo extends Solo {
    ...
    public boolean waitForView(String id) {
        ...
        if (waitForView)
            ReportLib.logWriter("等待" + id, true, true, ReportLib.pass);
        else ReportLib.logWriter("等待" + id, true, false, ReportLib.fail);
        return waitForView;
    }
    ...
    public void clickOnView(View p_View, String id) {
        ...
        if (p_View == null) {
            ...
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + id, null, null, ReportLib.fail);
            return;
        }
        ...
        try {
            if (super.waitForView(p_View, ObjectWaitTime, false)) {
                ...
                ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + name, null, null, ReportLib.pass);
            } else {
                shotScreen(shotImage);
                ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + name, null, null, ReportLib.fail);
                Log.e(Tag, DebugInfoStore.Info_Click + DebugInfoStore.Info_View
                        + p_View + DebugInfoStore.Info_Fail);
            }
        } catch (Exception e) {
            shotScreen(shotImage);
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + name, DebugInfoStore.Info_Pass, e.getMessage(), ReportLib.exception);
            Log.e(Tag, DebugInfoStore.Info_Click + DebugInfoStore.Info_View
...
//        try {
        ...
        if (result) {
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "找到有\"" + p_Text + "\"字样的控件", null, null, ReportLib.pass);
        } else {
            shotImage = CommonLib.getCurrentTime() + ".jpg";
            shotScreen(shotImage);
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "无法找到包含\"" + p_Text + "\"字样的控件", null, null, ReportLib.exception);
        }
    }
    ...
    public void enterTextInWebElement(By by, String p_Text) {
        try {
            ...
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Type + p_Text, DebugInfoStore.Info_Pass, DebugInfoStore.Info_Pass, ReportLib.pass);
        } catch (Exception e) {
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Type + p_Text, DebugInfoStore.Info_Pass, e.getMessage(), ReportLib.exception);
        }
    }
    ...
    public void clickOnMenuItem(String p_Text) {
        ...
        try {
            ...
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + DebugInfoStore.Info_Menu + p_Text, DebugInfoStore.Info_Pass, DebugInfoStore.Info_Pass, ReportLib.pass);
            Log.i(Tag, DebugInfoStore.Info_Click + DebugInfoStore.Info_Menu
                    + p_Text + DebugInfoStore.Info_Pass);
        } catch (Exception e) {
            shotScreen(shotImage);
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + DebugInfoStore.Info_Menu + p_Text, DebugInfoStore.Info_Pass, e.getMessage(), ReportLib.exception);
    ...
    public void clickOnActionBarHomeButton() {
        ...
        ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + DebugInfoStore.Info_HomeKey, null, null, ReportLib.pass);
    ...
    public void verifyEquals(String p_message, Object p_expected,
        ...
        if (p_expected.equals(p_actual)) {
            ...
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "验证" + p_message, p_expected, p_actual, ReportLib.pass);
        } else {
            Log.e(Tag, p_message + DebugInfoStore.Info_Fail + "expected="
                    + p_expected + " actual=" + p_actual);
            shotScreen(shotImage);
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + p_message, p_expected, p_actual, ReportLib.fail);
    ...
    public boolean waitForActivity(String name, int timeout) {
        ...
        if (waitForActivity) {
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "等待" + name + "开启", null, null, ReportLib.pass);
        } else {
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "等待" + name + "开启", null, null, ReportLib.fail);
        }
    ...
    public boolean waitForActivity(Class<? extends Activity> activityClass, int timeout) {
        ...
        if (waitForActivity) {
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "等待" + activityClass.getSimpleName() + "开启", null, null, ReportLib.pass);
        } else {
            ReportLib.logWriter(getCurrentActivity().getClass() + ":" + "等待" + activityClass.getSimpleName() + "开启", null, null, ReportLib.fail);
        }
        return waitForActivity;
    }
    ...
    public void clickView(String id, int index) {
        ...
        try {
            if (super.waitForView(view, APIWaitTime, false)) {
                ...
                ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Click + DebugInfoStore.Info_View
    ...
    public void pullDown() {
        ...
        ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_PullDown, null, null, ReportLib.pass);
    }
    ...
    public void pullTop() {
        ...
        ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_PullTop, null, null, null);
    ...
    public void pull2left() {
        ...
        ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Swip2Left, null, null, null);
    }
    ...
    public void pull2right() {
        ...
        ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Swip2Right, null, null, null);
    }
    ...
    public void sleep() {
        // TODO Auto-generated method stub
        ReportLib.logWriter(getCurrentActivity().getClass() + ":" + DebugInfoStore.Info_Wait + webElementWaitTime + "毫秒", null, null, ReportLib.pass);
